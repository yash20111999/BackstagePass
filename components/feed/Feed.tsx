...
const Feed: React.FC<FeedProps> = ({ posts }) => {
  // Container styling
  const feedWrapper = "flex flex-col w-full min-w-0 h-[calc(100dvh-100px)] min-h-[600px] overflow-y-auto";
  const pageBackground = "bg-[var(--bg-page)] min-h-screen max-w-3xl self-center";
  const postsContainer = "flex flex-col gap-6 bg-[var(--bg-surface)] space-y-0 border border-[var(--border-default)] rounded-2xl px-3 py-3";
